...
For the deeper operating rules behind these prompts, use [AI-Assisted Requirements Management](../framework/AI-Assisted%20Requirements%20Management.md).
...
- checking after `2-3` weeks whether the questions changed behavior or only created status updates
