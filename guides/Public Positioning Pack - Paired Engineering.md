...
- keep the repository or project subtitle tied to `AI Enablement`
- lead the landing experience with `Paired Engineering`
- use the one-pager and public deck as the first public artifacts
