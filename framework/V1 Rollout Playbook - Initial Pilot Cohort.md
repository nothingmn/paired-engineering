...
- `Weeks 0-1`: Phase 1 alignment and boundaries
- `Weeks 1-2`: Phase 2 baseline and workflow discovery
- `Weeks 3-6`: Phase 3 paired-engineering pilot
- `Weeks 6-8`: Phase 4 capability-aware expansion
- `Weeks 8-10`: Phase 5 standards and self-service support
- `Weeks 10-12`: Phase 6 review and scale decision

## Recommended pilot shape

- `1` technical enablement lead
- a bounded initial pilot cohort sized to the organization
- `2-4` workflows per role at most
